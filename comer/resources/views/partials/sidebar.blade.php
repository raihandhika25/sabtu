        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/" class="flex ml-2 md:mr-24">
                    <img src="/img/logo1.png" class="h-12 mr-3" />
                    <span
                        class="self-center text-xl txt-kt font-semibold sm:text-2xl whitespace-nowrap text-green-900 dark:text-white">Action Figure</span>
                </a>
            </div>
                ...
                <div class="flex items-center ml-3">
                    <div>
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full" src="/img/amanda.jpeg" alt="user photo">
                        </button>
                    </div>
