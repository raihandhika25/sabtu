        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form enctype="multipart/form-data" class="space-y-6" action="/barang/storeinput" method="post">
                        @csrf
                        <div>
                            <label for="nama"
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col">
                        Tipe </th> <th scope="col"> Harga </th> <th scope="col"> Stok </th> <th scope="col"> Gambar </th> <th scope="col"> Option
                    </th>
                </tr>
            </thead>
            <tbody>
                @foreach ($produk as $b)
                    <tr
                        ...
                        <td class="flex items-center h-32">
                            ...
                            <form class="" action="/barang/delete/{{ $b->kode }}" method="get">
                        ...
                        <div class="relative w-full max-w-md max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    ...
                                    <form class="space-y-6" action="/barang/storeupdate" method="post">
                                        @csrf
                                        ...
                                        <div>
                                            ...
                                            <input type="hidden" value="{{ $b->gambar }}" name="foto"
                                                id=""
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
