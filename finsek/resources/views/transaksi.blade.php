            ...
            @foreach ($transaksi as $p)
                <tr>
                    ...
                    <td>
                        ...
                        data-bs-target="#modalupdateprodak{{$p->kode_pembeli}}">Update</button>

                        <button class="btn--btn-info" data-bs-toggle="modal"
                        data-bs-target="#modalupdateprodak{{$p->kode_pembeli}}">Delet</button>
                        @endif   
                    </td>
                </tr>

                <!-- Ini tampil form update transaksi -->
                <div class="modal fade" id="ModalUpdatetransaksi{{ $p->kode_pembeli }}" tabindex="-1"
                ...
                <div class="modal fade" id="ModalDeletebiodata{{ $p->kode_pembeli }}" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form action="/transaksi/delete/{{ $p->kode_pembeli }}" method="get" class="form-floating">
                                    @csrf
                                    <div>
                                        <h3>Yakin mau menghapus data <b>{{ $p->kode_pembeli }}</b> ?</h3>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
