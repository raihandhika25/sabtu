    ...
    <nav class="navbar navbar-expand-lg p-5 bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @if(
                    Auth::user()->role=='kantin')
                    <li class="nav-item">
                        <a class="nav-link" href="/prodak/tampil">Produk</a>
                    </li>
                    @endif
                    @if(Auth::user()->role=='Guest' or Auth::user()->role=='Admin')
                    <li class="nav-item">
                        <a class="nav-link" href="/transaksi/tampil">Pembelian</a>
                    </li>
                    @endif
                    <li class="nav-item">
                        <a class="nav-link btn btn-primary" href="/">Belanja</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
