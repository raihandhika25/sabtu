        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/" class="flex ml-2 md:mr-24">
                    <img src="/img/logo.png" class="h-12 mr-3" />
                    <span
                        class="self-center text-black txt-kt font-semibold sm:text-2xl whitespace-nowrap text-blue-900 dark:text-black">NIKE</span>
                </a>
            </div>
